...
def load_data_fashion_mnist(batch_size, resize=None, root='/home/mylady/ai_data/d2l_data/FashionMNIST'):
...
<<<<<<< HEAD
def download(name, cache_dir=os.path.join('/mnt/F4E69028E68FE8E6/Datasets_on_HHD', 'data')):
=======
def download(name, cache_dir=None):
>>>>>>> 047212c9d3a7decf191c3b4b0ebff58bd2c86056
