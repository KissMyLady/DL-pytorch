...
class AdditiveAttention(nn.Module):
    """Additive attention.
    Defined in `sec_attention-scoring-functions`
...
class DotProductAttention(nn.Module):
    ...
    Defined in `subsec_additive-attention`
...
class AttentionDecoder(Decoder):
    ...
    Defined in  `sec_seq2seq_attention`

    定 义: 10.4 Bahdanau 注意力
    描 述: 带有注意力机制解码器的基本接口
